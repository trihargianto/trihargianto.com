...
featured: cover.jpg
pubDate: 2020-12-04
featuredSourceUrl: "https://www.freepik.com/vectors/school"
featuredSource: "upklyak"
tags: ["how-to", "testing", "javascript"]
---
...
![Yarn init - Pertanyaan Pertama](images/yarn-init-question-1.png)

<p align="center">
  <small>
    <i>Gambar 1: Yarn Init - Pertanyaan pertama</i>
  </small>
</p>
...
![Yarn init - Pertanyaan Kedua](images/yarn-init-question-2.png)

<p align="center">
  <small>
    <i>Gambar 2: Yarn Init - Pertanyaan kedua</i>
  </small>
</p>

Sisa pertanyaan lainnya bisa dilihat di _screenshot_ berikut (kamu bebas mengatur sesuai kebutuhanmu):

![Yarn init - Rekap Jawaban](images/yarn-init-answers.png)

<p align="center">
  <small>
    <i>Gambar 3: Yarn Init - Rekap Jawaban</i>
  </small>
</p>
...
![Bersih. Tidak ada laporan dari Eslint](images/clean-eslint.png)

<p align="center">
  <small>
    <i>Gambar 4: Eslint Bersih. Tidak ada laporan error</i>
  </small>
</p>
...
![Warning dari Eslint. Tidak boleh ada `console.log` di dalam kode](images/eslint-no-console-warning.png)

<p align="center">
  <small>
    <i>Gambar 5: Eslint Bersih. Tidak ada laporan error</i>
  </small>
</p>
...
![Ekstensi Eslint di VSCode](images/eslint-vscode.png)

<p align="center">
  <small>
    <i>Gambar 6: Ekstensi Eslint di VSCode</i>
  </small>
</p>
...
![Variabel tidak terpakai](images/eslint-no-unused-vars.png)

<p align="center">
  <small>
    <i>Gambar 7: Variabel tidak terpakai</i>
  </small>
</p>
...
![Autofix Eslint di VSCode](images/vscode-eslint-autofix.png)

<p align="center">
  <small>
    <i>Gambar 8: Autofix Eslint di VSCode</i>
  </small>
</p>
...
import WarWebm from "images/war.webm";
import WarMp4 from "images/war.mp4";

<Video webm={WarWebm} mp4={WarMp4} />

<p align="center">
  <small>
    <i>Gambar 9: Ilustrasi pertengkaran konfigurasi Eslint dan Prettier</i>
  </small>
</p>
...
[Lint-Staged](https://github.com/okonet/lint-staged) hadir sebagai solusi untuk masalah ini ✨
