...
featured: cover.png
pubDate: 2021-05-30
featuredSourceUrl: "https://medium.com/mamikos-design"
featuredSource: "Mamikos Design Team"
---
...
![Principles Illustration](images/ideas.jpg)

<p align="center">
  <small>
    <i>Principles Illustration</i>
  </small>
</p>
...
![Ilustrasi Pemilihan Teknologi](images/research.jpg)

<p align="center">
  <small>
    <i>Ilustrasi Pemilihan Teknologi</i>
  </small>
</p>
...
Selanjutnya, ketika kami melakukan perubahan kode, lalu test runner dijalankan, ia akan meng-capture semua komponen menjadi kumpulan i dan membandingkan semua gambarnya dengan yang sudah di capture sebelumnya.

Dengan begini kami bisa tau semua perubahan yang terjadi, dari perubahan yang disengaja dan tak disengaja.

import ComponentVisualTestingWebm from "images/component-visual-testing.webp";
import ComponentVisualTestingMp4 from "images/component-visual-testing.mp4";

<Video webm={ComponentVisualTestingWebm} mp4={ComponentVisualTestingMp4} />
...
![Property yang disediakan](images/demo-button-property.png)

<p align="center">
  <small>
    <i>Property yang disediakan</i>
  </small>
</p>

3. Variasi yang tersedia di tiap komponen

![Variasi Komponen Button](images/demo-button-variant.png)

<p align="center">
  <small>
    <i>Variasi Komponen Button</i>
  </small>
</p>
...
import DemoButtonPlaygroundWebm from "images/demo-button-playground.webp";
import DemoButtonPlaygroundMp4 from "images/demo-button-playground.mp4";

<Video webm={DemoButtonPlaygroundWebm} mp4={DemoButtonPlaygroundMp4} />
...
![Design Sync Meetup](images/meeting.jpg)

<p align="center">
  <small>
    <i>Design Sync Meetup</i>
  </small>
</p>
