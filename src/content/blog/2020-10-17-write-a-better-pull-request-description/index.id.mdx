...
pubDate: "2020-10-17"
featured: cover.jpg
featuredSourceUrl: "https://www.pexels.com/@thisisengineering?utm_content=attributionCopyText&utm_medium=referral&utm_source=pexels"
featuredSource: "ThisIsEngineering"
tags: ["development", "opinion", "best-practice", "how-to"]
---
...
import WhyShouldICareWebm from "images/why-should-i-care.webm";
import WhyShouldICareMp4 from "images/why-should-i-care.mp4";

<Video webm={WhyShouldICareWebm} mp4={WhyShouldICareMp4} />

<p align="center">
  <small>
    <i>Gambar 1: Kenapa saya harus peduli?</i>
  </small>
</p>
...
![Bad PR Example](images/bad-pr-example.png)

<p align="center">
  <small>
    <i>Gambar 2: Bad PR Example</i>
  </small>
</p>
