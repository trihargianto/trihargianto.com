...
<div class="flex flex-col-reverse md:flex-row md:gap-8">
  <div class="w-full md:w-2/3">
    ...
    <a href="mailto:trihargianto@gmail.com">trihargianto@gmail.com</a>
  ...
  <div class="w-full md:w-80">
    ...
    Indonesia](https://maps.app.goo.gl/2vfZA4xCvVkqXovS6).</p>
     ...
     <Image src={MeTakingASipImage} alt="Tri Hargianto taking a sip" class="rotate-3 h-auto transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0" />
