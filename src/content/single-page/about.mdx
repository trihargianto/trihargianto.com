...
<div class="flex flex-col-reverse md:flex-row md:gap-8">
  <div class="w-full md:w-2/3">
    <p class="hidden md:block">Hello, I'm Tri Hargianto, a Software Engineer based in [Indonesia](https://maps.app.goo.gl/XGLyrMR8CztRz9JC6).</p>
  ...
  <div class="w-full md:w-80">
    <p class="block md:hidden mb-10">Hello, I'm Tri Hargianto, a Software Engineer based in [Indonesia](https://maps.app.goo.gl/XGLyrMR8CztRz9JC6).</p>
...
<div class="flex flex-col lg:flex-row md:gap-8">
  ...
  <div class="w-full lg:w-2/3">
    I'm a co-organizer of [JogjaJS](https://jogjajs.org/), a JavaScript community in [Yogyakarta, Indonesia](https://maps.app.goo.gl/D8DFmdet4cuz58VL8). We regularly host meetups, workshops, and other events to support the growth of developers.

    To date, we have over **1000 members**, conducted more than **30 events**, and have been contributing for over **8 years**.

    <span class="block sm:hidden md:block">This makes JogjaJS as one of the largest JavaScript community in Indonesia.</span>
...
- [Elevate](https://addyo.substack.com/): A newsletter on elevating your effectiveness. Created by [Addy Osmani](https://addyosmani.com/).
- [Frontend Focus](https://frontendfoc.us/): A weekly newsletter for front-end developers.
- [Bytes Dev](https://bytes.dev/): JavaScript, React, Node.js, and more. A weekly newsletter for developers.
...
- [Claude Code](https://github.com/anthropics/claude-code): Agentic coding tool.
...
- [Dia Browser](https://www.diabrowser.com/): A modern AI-oriented web browser designed for speed and efficiency.
