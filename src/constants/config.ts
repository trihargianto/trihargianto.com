...
// Book Shelf will be redirected via Netlify Redirects
export const BOOK_SHELF_LINK = "https://trihargianto.com/bookshelf";

// Mentorship will be redirected via Netlify Redirects
export const MENTORSHIP_LINK = "https://trihargianto.com/mentorship";

// Bookmarks will be redirected via Netlify Redirects
export const BOOKMARKS_LINK = "https://trihargianto.com/bookmarks";
