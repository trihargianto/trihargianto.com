    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          className="icon icon-tabler icons-tabler-outline icon-tabler-brand-medium"
          style={{ marginTop: "-2px" }}
          aria-labelledby="MediumIconTitle"
          role="img"
        >
...
function ExternalLink({ href, children, title, ...props }: ExternalLinkProps) {
  return (
    <a
      href={href}
      target="_blank"
